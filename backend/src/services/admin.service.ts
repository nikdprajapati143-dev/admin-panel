...
export class AdminService {
    ...
    async createAdmin(
        ...
        // Trigger welcome email with autogenerated temporary password
        this.emailService.sendAdminCreatedEmail({
            name: data.name,
            email: data.email,
            role: role.name,
            temporaryPassword: rawPassword,
        }).catch((err) => console.error("Failed to send admin created email:", err));
